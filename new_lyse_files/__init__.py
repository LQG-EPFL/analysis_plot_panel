...
class Run(object):
    ...
    def open_file_read(func):
        def a_wrapper(self, *args, h5_file = None, **kwargs):
            if h5_file == None:
    ...
    @open_file_write
    def save_results(self, *args, print_out=True, h5_file = None,**kwargs):
    ...
    @open_file_write
    def save_total_results_dict(self, total_results_dict, h5_file = None):
